...
from .views import CategoryViewSet, PostViewSet, CommentViewSet, LikeViewSet, CategoryListCreateAPIView, PostListCreateAPIView, CommentListCreateAPIView, LikeListCreateAPIView, CategoryDetailAPIView, PostDetailAPIView, CommentDetailAPIView, LikeDetailAPIView, HashTagViewSet, HashTagListCreateAPIView, HashTagDetailAPIView, UserListCreateAPIView, UserDetailsAPIView
...
urlpatterns = [
    ...
    path('api/users/<int:pk>/', UserDetailsAPIView.as_view(), name='user-details'),
